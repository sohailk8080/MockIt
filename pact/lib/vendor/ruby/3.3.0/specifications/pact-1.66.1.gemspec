# -*- encoding: utf-8 -*-
# stub: pact 1.66.1 ruby lib

Gem::Specification.new do |s|
  s.name = "pact".freeze
  s.version = "1.66.1".freeze
  ...
  s.add_runtime_dependency(%q<string_pattern>.freeze, ["~> 2.0".freeze])
  s.add_runtime_dependency(%q<jsonpath>.freeze, ["~> 1.0".freeze])
  s.add_runtime_dependency(%q<pact-support>.freeze, ["~> 1.21".freeze, ">= 1.21.0".freeze])
  ...
  s.add_development_dependency(%q<faraday>.freeze, ["~> 2.0".freeze, "< 3.0".freeze])
