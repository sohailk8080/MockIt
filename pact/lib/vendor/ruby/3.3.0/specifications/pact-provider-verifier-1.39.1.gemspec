# -*- encoding: utf-8 -*-
# stub: pact-provider-verifier 1.39.1 ruby lib

Gem::Specification.new do |s|
  s.name = "pact-provider-verifier".freeze
  s.version = "1.39.1".freeze
  ...
  s.executables = ["pact-provider-verifier".freeze, "pact-provider-verifier.cmd".freeze]
  s.files = ["bin/pact-provider-verifier".freeze, "bin/pact-provider-verifier.cmd".freeze]
  ...
  s.add_runtime_dependency(%q<rack-reverse-proxy-pact>.freeze, [">= 0".freeze])
