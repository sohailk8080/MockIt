...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<code_stats>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<minitest>.freeze, ["~> 2.2.0".freeze])
  s.add_development_dependency(%q<phocus>.freeze, [">= 0".freeze])
